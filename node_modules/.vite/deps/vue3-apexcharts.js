...
var Li = function() {
  ...
  return s(t2, [{ key: "getDefaultFilter", value: function(t3, e2) {
    ...
    if (h3 = Array.isArray(h3) ? h3[e2] : h3, (null === (s2 = r2.config.chart.dropShadow.enabledOnSeries) || void 0 === s2 ? void 0 : s2.length) > 0 && -1 === r2.config.chart.dropShadow.enabledOnSeries.indexOf(e2))
      return t3;
    ...
    if (t3.unfilter(true), v.isMsEdge() && "radialBar" === h3.config.chart.type)
      return t3;
    if ((null === (i2 = h3.config.chart.dropShadow.enabledOnSeries) || void 0 === i2 ? void 0 : i2.length) > 0 && -1 === (null === (s2 = h3.config.chart.dropShadow.enabledOnSeries) || void 0 === s2 ? void 0 : s2.indexOf(l2)))
      return t3;
...
var Mi = function() {
  ...
  return s(t2, [{ key: "roundPathCorners", value: function(t3, e2) {
    ...
    var I2 = !!(L2 && !A3.globals.resized || M2 && A3.globals.dataChanged && A3.globals.shouldAnimate);
    I2 ? e2 = s2 : (e2 = r2, A3.globals.animationEnded = true);
    var T2 = A3.config.stroke.dashArray, z2 = 0;
    z2 = Array.isArray(T2) ? T2[a2] : A3.config.stroke.dashArray;
    var X2 = this.drawPath({ d: e2, stroke: n2, strokeWidth: o2, fill: h3, fillOpacity: 1, classes: p2, strokeLinecap: l2, strokeDashArray: z2 });
    X2.attr("index", a2), b2 && ("bar" === f2 && !A3.globals.isHorizontal || A3.globals.comboCharts ? X2.attr({ "clip-path": "url(#gridRectBarMask".concat(A3.globals.cuid, ")") }) : X2.attr({ "clip-path": "url(#gridRectMask".concat(A3.globals.cuid, ")") })), A3.config.chart.dropShadow.enabled && k2 && C2.dropShadow(X2, A3.config.chart.dropShadow, a2), v2 && (X2.node.addEventListener("mouseenter", this.pathMouseEnter.bind(this, X2)), X2.node.addEventListener("mouseleave", this.pathMouseLeave.bind(this, X2)), X2.node.addEventListener("mousedown", this.pathMouseDown.bind(this, X2))), X2.attr({ pathTo: r2, pathFrom: s2 });
    var R2 = { el: X2, j: i2, realIndex: a2, pathFrom: s2, pathTo: r2, fill: h3, strokeWidth: o2, delay: c2 };
    return !L2 || A3.globals.resized || A3.globals.dataChanged ? !A3.globals.resized && A3.globals.dataChanged || S2.showDelayedElements() : S2.animatePathsGradually(u(u({}, R2), {}, { speed: d2 })), A3.globals.dataChanged && M2 && I2 && S2.animatePathsGradually(u(u({}, R2), {}, { speed: g2 })), X2;
  ...
  return s(t2, [{ key: "getStackedSeriesTotals", value: function() {
    ...
    if (e2 = r2.xRange / r2.gridWidth, t3 = r2.yRange / r2.gridWidth, i2 = r2.xRange / r2.gridHeight, (o2 = r2.zRange / r2.gridHeight * 16) || (o2 = 1), r2.minY !== Number.MIN_VALUE && 0 !== Math.abs(r2.minY) && (r2.hasNegs = true), s2.globals.seriesYAxisReverseMap.length > 0) {
      ...
      if (r2.isMultipleYAxis) {
        ...
        (l2 = []).push(g2(r2.minY, 0)), r2.minY !== Number.MIN_VALUE && 0 !== Math.abs(r2.minY) && (h3 = -r2.minY / t3, c2 = r2.minX / e2);
    } else
      (l2 = []).push(0), h3 = 0, c2 = 0;
    ...
    if (Array.isArray(d2.x))
      for (var f2 = 0; f2 < d2.x.length; f2++) {
        ...
        if ("line" !== h3.config.chart.type && "area" !== h3.config.chart.type || h3.globals.comboCharts || h3.config.tooltip.intersect || (y2 += " no-pointer-events"), (Array.isArray(h3.config.markers.size) ? h3.globals.markers.size[i2] > 0 : h3.config.markers.size > 0) || n2 || p2) {
          ...
          if (h3.config.series[c2].data[b2] && (h3.config.series[c2].data[b2].fillColor && (w2.pointFillColor = h3.config.series[c2].data[b2].fillColor), h3.config.series[c2].data[b2].strokeColor && (w2.pointStrokeColor = h3.config.series[c2].data[b2].strokeColor)), void 0 !== s2 && (w2.pSize = s2), (d2.x[f2] < -h3.globals.markers.largestSize || d2.x[f2] > h3.globals.gridWidth + h3.globals.markers.largestSize || d2.y[f2] < -h3.globals.markers.largestSize || d2.y[f2] > h3.globals.gridHeight + h3.globals.markers.largestSize) && (w2.pSize = 0), !m3)
            (h3.globals.markers.size[i2] > 0 || n2 || p2) && !u2 && (u2 = g2.group({ class: n2 || p2 ? "" : "apexcharts-series-markers" })).attr("clip-path", "url(#gridRectMarkerMask".concat(h3.globals.cuid, ")")), (x2 = g2.drawMarker(d2.x[f2], d2.y[f2], w2)).attr("rel", b2), x2.attr("j", b2), x2.attr("index", i2), x2.node.setAttribute("default-marker-size", w2.pSize), new Li(this.ctx).setSelectionFilter(x2, i2, b2), this.addEvents(x2), u2 && u2.add(x2);
        } else
          void 0 === h3.globals.pointsArray[i2] && (h3.globals.pointsArray[i2] = []), h3.globals.pointsArray[i2].push([d2.x[f2], d2.y[f2]]);
      }
    return u2;
...
var Ui = function() {
  ...
  return s(t2, [{ key: "draw", value: function(t3, e2, i2) {
    ...
    if (h3.attr("clip-path", "url(#gridRectMarkerMask".concat(a2.globals.cuid, ")")), Array.isArray(n2.x))
    ...
    for (var x2 = 0; x2 < a2.x.length; x2++)
      if (u2 = a2.x[x2] + d2.offsetX, g2 = a2.y[x2] + d2.offsetY + l2, !isNaN(u2)) {
        ...
        if ("bubble" === h3.config.chart.type)
          m3 = v2(b2 = h3.globals.seriesZ[s2][p2]), g2 = a2.y[x2], g2 = new Ui(this.ctx).centerTextInBubble(g2, s2, p2).y;
        else
          void 0 !== b2 && (m3 = v2(b2));
...
var Zi = function() {
  ...
  return s(t2, [{ key: "getAllSeriesEls", value: function() {
    ...
    for (var h3 = 0; h3 < s2.length; h3++)
      s2[h3].classList.add(this.legendInactiveClass);
    if (r2)
  ...
  return s(t2, [{ key: "isMultiFormat", value: function() {
    ...
    for (var o2 = 0; o2 < t3[r2].data.length; o2++) {
      ...
      if (l2 || c2)
        ...
        h3 ? (this.fallbackToCategory = true, this.twoDSeriesX.push(t3[r2].data[o2].x)) : (a2.isXNumeric = true, a2.dataFormatXNumeric = true, this.twoDSeriesX.push(t3[r2].data[o2].x));
    }
    ...
    if ("array" === t3)
      if (s2 && 6 === e2[i2].data[0].length || !s2 && 5 === e2[i2].data[0].length)
        for (var c2 = 0; c2 < e2[i2].data.length; c2++)
          r2.push(e2[i2].data[c2][1]), n2.push(e2[i2].data[c2][2]), s2 ? (o2.push(e2[i2].data[c2][3]), l2.push(e2[i2].data[c2][4]), h3.push(e2[i2].data[c2][5])) : (l2.push(e2[i2].data[c2][3]), h3.push(e2[i2].data[c2][4]));
      else
        for (var d2 = 0; d2 < e2[i2].data.length; d2++)
          Array.isArray(e2[i2].data[d2][1]) && (r2.push(e2[i2].data[d2][1][0]), n2.push(e2[i2].data[d2][1][1]), s2 ? (o2.push(e2[i2].data[d2][1][2]), l2.push(e2[i2].data[d2][1][3]), h3.push(e2[i2].data[d2][1][4])) : (l2.push(e2[i2].data[d2][1][2]), h3.push(e2[i2].data[d2][1][3])));
    else if ("xy" === t3)
      for (var u2 = 0; u2 < e2[i2].data.length; u2++)
        Array.isArray(e2[i2].data[u2].y) && (r2.push(e2[i2].data[u2].y[0]), n2.push(e2[i2].data[u2].y[1]), s2 ? (o2.push(e2[i2].data[u2].y[2]), l2.push(e2[i2].data[u2].y[3]), h3.push(e2[i2].data[u2].y[4])) : (l2.push(e2[i2].data[u2].y[2]), h3.push(e2[i2].data[u2].y[3])));
      ...
      if (l2.globals.axisCharts) {
        if ("category" === l2.config.xaxis.type || l2.config.xaxis.convertedCatToNumeric)
          if (l2.globals.isBarHorizontal) {
            ...
            i3 = m3.getLabel(l2.globals.labels, l2.globals.timescaleLabels, 0, t4).text;
  ...
  return s(t2, [{ key: "drawGridArea", value: function() {
    ...
    if (s2.config.grid.xaxis.lines.show || s2.config.xaxis.axisTicks.show) {
      ...
      s2.globals.timescaleLabels.length ? function(t4) {
        ...
        for (var a3 = t4.xC, r3 = t4.x1, n3 = t4.y1, o3 = t4.x2, l3 = t4.y2, h4 = 0; h4 < a3 + (s2.globals.isXNumeric ? 0 : 1); h4++)
          0 === h4 && 1 === a3 && 1 === s2.globals.dataPoints && (o3 = r3 = s2.globals.gridWidth / 2), e2._drawGridLines({ i: h4, x1: r3, y1: n3, x2: o3, y2: l3, xCount: i2, parent: e2.elgridLinesV }), o3 = r3 += s2.globals.gridWidth / (s2.globals.isXNumeric ? a3 - 1 : a3);
    ...
    if (s2.config.grid.yaxis.lines.show) {
      ...
      for (var u2 = 0; u2 < d2 + (this.isRangeBar ? 1 : 0); u2++)
        this._drawGridLine({ i: u2, xCount: d2 + (this.isRangeBar ? 1 : 0), x1: 0, y1: l2, x2: c2, y2: h3, parent: this.elgridLinesH }), h3 = l2 += s2.globals.gridHeight / (this.isRangeBar ? d2 : a2);
    }
    ...
    if (i2.config.grid.yaxis.lines.show)
      for (var o2 = 0, l2 = 0, h3 = i2.globals.gridWidth, c2 = 0; c2 < i2.globals.dataPoints + 1; c2++)
        this._drawGridLine({ i: c2, xCount: i2.globals.dataPoints + 1, x1: 0, y1: o2, x2: h3, y2: l2, parent: this.elgridLinesH }), l2 = o2 += i2.globals.gridHeight / i2.globals.dataPoints;
...
var ta = function() {
  ...
  return s(t2, [{ key: "niceScale", value: function(t3, e2) {
    ...
    e2 <= 0 && (e2 = Math.max(t3, i2)), t3 <= 0 && (t3 = Math.min(e2, i2));
    for (var a2 = [], s2 = Math.log(e2) / Math.log(i2), r2 = Math.log(t3) / Math.log(i2), n2 = s2 - r2, o2 = Math.round(n2), l2 = n2 / o2, h3 = 0, c2 = r2; h3 < o2; h3++, c2 += l2)
    ...
    for (var p2 = t3; p2 < a2; p2++) {
      ...
      for (var m3 = x2; m3 <= b2 && m3 < r2.series[p2].length; m3++) {
        ...
        if (null !== y2 && v.isNumber(y2)) {
          var w2, k2, A3, C2;
          switch (void 0 !== (null === (w2 = c2[p2]) || void 0 === w2 ? void 0 : w2[m3]) && (n2 = Math.max(n2, c2[p2][m3]), e2 = Math.min(e2, c2[p2][m3])), void 0 !== (null === (k2 = h3[p2]) || void 0 === k2 ? void 0 : k2[m3]) && (e2 = Math.min(e2, h3[p2][m3]), i2 = Math.max(i2, h3[p2][m3])), f2) {
            case "candlestick":
          ...
          }), i2 = n2, y2 = v.noExponents(y2), v.isFloat(y2) && (r2.yValueDecimal = Math.max(r2.yValueDecimal, y2.toString().split(".")[1].length)), o2 > (null === (A3 = h3[p2]) || void 0 === A3 ? void 0 : A3[m3]) && (null === (C2 = h3[p2]) || void 0 === C2 ? void 0 : C2[m3]) < 0 && (o2 = h3[p2][m3]);
        } else
...
var ia = function() {
  ...
  return s(t2, [{ key: "drawYaxis", value: function(t3) {
    ...
    if (c2.length > 0 && (this.xaxisLabels = c2.slice(), r2 = (h3 = c2.slice()).length), e2.config.xaxis.labels.show)
    ...
    if (0 !== a2.responsive.length) {
      ...
      var r2 = new Wi({}), n2 = function() {
        ...
        if (n3 > a3) {
          ...
          for (var h3 = 0; h3 < s2.length; h3++)
            n3 < s2[h3].breakpoint && (t4 = Pi.extendArrayProps(r2, s2[h3].options, i2), t4 = v.extend(i2.config, t4), e2.overrideResponsiveOptions(t4));
      };
      if (t3) {
...
var xa = function() {
  ...
  return s(t2, [{ key: "init", value: function() {
    ...
    if (d2.height = 2 * (o2 + c2) + "px", d2.width = 2 * (o2 + c2) + "px", d2.left = l2 + "px", d2.top = h3 + "px", a2.config.legend.markers.customHTML)
...
var ba = function() {
  ...
  return s(t2, [{ key: "createToolbar", value: function() {
    ...
    for (var h3 = 0; h3 < r2.length; h3++)
      Mi.setAttrs(r2[h3].el, { class: r2[h3].class, title: r2[h3].title }), r2[h3].el.innerHTML = r2[h3].icon, a2.appendChild(r2[h3].el);
...
var va = function() {
  ...
  return s(t2, [{ key: "getNearestValues", value: function(t3) {
    ...
    for (var s2, r2 = this.w, n2 = 1 / 0, o2 = null, l2 = null, h3 = 0; h3 < i2.length; h3++)
      if (s2 = h3, -1 === r2.globals.collapsedSeriesIndices.indexOf(s2) && -1 === r2.globals.ancillaryCollapsedSeriesIndices.indexOf(s2))
        for (var c2 = i2[h3], d2 = a2[h3], u2 = Math.min(c2.length, d2.length), g2 = 0; g2 < u2; g2++) {
  ...
  return s(t2, [{ key: "drawSeriesTexts", value: function(t3) {
    ...
    for (var m3 = function(t4, r3) {
      ...
      if (h3.globals.axisCharts) {
        ...
        if (o2)
          m4 = i2.getFormatters(v3), x2 = i2.getSeriesName({ fn: m4.yLbTitleFormatter, index: v3, seriesIndex: a2, j: s2 }), b2 = h3.globals.colors[v3], e2 = y3(v3), d2(v3) && (c2 = h3.globals.seriesGoals[v3][s2].map(function(t5) {
    ...
    }, v2 = 0, y2 = h3.globals.series.length - 1; v2 < h3.globals.series.length; v2++, y2--)
      m3(v2, y2);
    ...
    if (n2 && f2[0]) {
      ...
      Array.isArray(h3.tConfig.enabledOnSeries) && -1 === h3.tConfig.enabledOnSeries.indexOf(e2) && (f2[0].parentNode.style.display = "none");
...
var wa = function() {
  ...
  return s(t2, [{ key: "moveXCrosshairs", value: function(t3) {
    ...
    if (l2 > a2.globals.gridWidth / 2 && (l2 = l2 - n2.ttWidth - o2 - 10), l2 > a2.globals.gridWidth - n2.ttWidth - 10 && (l2 = a2.globals.gridWidth - n2.ttWidth), l2 < -20 && (l2 = -20), a2.config.tooltip.followCursor) {
      ...
      a2.globals.isBarHorizontal || n2.ttHeight / 2 + h3 > a2.globals.gridHeight && (h3 = a2.globals.gridHeight - n2.ttHeight + a2.globals.translateY);
  ...
  return s(t2, [{ key: "getElTooltip", value: function(t3) {
    ...
    if (t3.globals.axisCharts && (s2 ? o2 = t3.globals.dom.baseEl.querySelectorAll(".apexcharts-series[data\\:longestSeries='true'] .apexcharts-marker") : a2 ? o2 = t3.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-bar-area, .apexcharts-series .apexcharts-candlestick-area, .apexcharts-series .apexcharts-boxPlot-area, .apexcharts-series .apexcharts-rangebar-area") : "heatmap" !== e2 && "treemap" !== e2 || (o2 = t3.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-heatmap, .apexcharts-series .apexcharts-treemap")), o2 && o2.length))
      for (var d2 = 0; d2 < o2.length; d2++)
        l2.push(o2[d2].getAttribute("cy")), h3.push(o2[d2].getAttribute("cx"));
    ...
    if (A3.config.legend.tooltipHoverFormatter) {
      ...
      for (var T2 = 0; T2 < I2.length; T2++) {
        ...
        if (k2)
          z2.innerHTML = A3.globals.collapsedSeriesIndices.indexOf(X2) < 0 ? E2 : R2;
...
var La = function() {
  ...
  return s(t2, [{ key: "handleBarDataLabels", value: function(t3) {
    var e2, i2, a2 = t3.x, s2 = t3.y, r2 = t3.y1, n2 = t3.y2, o2 = t3.i, l2 = t3.j, h3 = t3.realIndex, c2 = t3.columnGroupIndex, d2 = t3.series, g2 = t3.barHeight, p2 = t3.barWidth, f2 = t3.barXPosition, x2 = t3.barYPosition, b2 = t3.visibleSeries, m3 = this.w, v2 = new Mi(this.barCtx.ctx), y2 = Array.isArray(this.barCtx.strokeWidth) ? this.barCtx.strokeWidth[h3] : this.barCtx.strokeWidth;
    m3.globals.isXNumeric && !m3.globals.isBarHorizontal ? (e2 = a2 + parseFloat(p2 * (b2 + 1)), i2 = s2 + parseFloat(g2 * (b2 + 1)) - y2) : (e2 = a2 + parseFloat(p2 * b2), i2 = s2 + parseFloat(g2 * b2));
    var w2, k2 = null, A3 = a2, C2 = s2, S2 = {}, L2 = m3.config.dataLabels, M2 = this.barCtx.barOptions.dataLabels, P2 = this.barCtx.barOptions.dataLabels.total;
    void 0 !== x2 && this.barCtx.isRangeBar && (i2 = x2, C2 = x2), void 0 !== f2 && this.barCtx.isVerticalGroupedRangeBar && (e2 = f2, A3 = f2);
    var I2 = L2.offsetX, T2 = L2.offsetY, z2 = { width: 0, height: 0 };
    if (m3.config.dataLabels.enabled) {
      var X2 = m3.globals.series[o2][l2];
      z2 = v2.getTextRects(m3.config.dataLabels.formatter ? m3.config.dataLabels.formatter(X2, u(u({}, m3), {}, { seriesIndex: o2, dataPointIndex: l2, w: m3 })) : m3.globals.yLabelFormatters[0](X2), parseFloat(L2.style.fontSize));
    }
    var R2 = { x: a2, y: s2, i: o2, j: l2, realIndex: h3, columnGroupIndex: c2, bcx: e2, bcy: i2, barHeight: g2, barWidth: p2, textRects: z2, strokeWidth: y2, dataLabelsX: A3, dataLabelsY: C2, dataLabelsConfig: L2, barDataLabelsConfig: M2, barTotalDataLabelsConfig: P2, offX: I2, offY: T2 };
    return S2 = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(R2) : this.calculateColumnsDataLabelsPosition(R2), w2 = this.drawCalculatedDataLabels({ x: S2.dataLabelsX, y: S2.dataLabelsY, val: this.barCtx.isRangeBar ? [r2, n2] : "100%" === m3.config.chart.stackType ? d2[h3][l2] : m3.globals.series[h3][l2], i: h3, j: l2, barWidth: p2, barHeight: g2, textRects: z2, dataLabelsConfig: L2 }), m3.config.chart.stacked && P2.enabled && (k2 = this.drawTotalDataLabels({ x: S2.totalDataLabelsX, y: S2.totalDataLabelsY, barWidth: p2, barHeight: g2, realIndex: h3, textAnchor: S2.totalDataLabelsAnchor, val: this.getStackedTotalDataLabel({ realIndex: h3, j: l2 }), dataLabelsConfig: L2, barTotalDataLabelsConfig: P2 })), { dataLabelsPos: S2, dataLabels: w2, totalDataLabels: k2 };
    ...
    if (this.barCtx.isVerticalGroupedRangeBar ? g2 += c2 / 2 : (g2 = i2.globals.isXNumeric ? h3 - c2 / 2 + v2 : h3 - C2 + c2 / 2 + v2, !i2.config.chart.stacked && A3 > 0 && i2.config.plotOptions.bar.hideZeroBarsWhenGrouped && (g2 -= c2 * A3)), k2) {
    ...
    var e2 = this, i2 = this.w, a2 = t3.x, s2 = t3.i, r2 = t3.j, n2 = t3.realIndex, o2 = t3.bcy, l2 = t3.barHeight, h3 = t3.barWidth, c2 = t3.textRects, d2 = t3.dataLabelsX, u2 = t3.strokeWidth, g2 = t3.dataLabelsConfig, p2 = t3.barDataLabelsConfig, f2 = t3.barTotalDataLabelsConfig, x2 = t3.offX, b2 = t3.offY, m3 = i2.globals.gridHeight / i2.globals.dataPoints, v2 = this.barCtx.barHelpers.getZeroValueEncounters({ i: s2, j: r2 }).zeroEncounters;
    h3 = Math.abs(h3);
    var y2, w2, k2 = o2 - (this.barCtx.isRangeBar ? 0 : m3) + l2 / 2 + c2.height / 2 + b2 - 3;
    !i2.config.chart.stacked && v2 > 0 && i2.config.plotOptions.bar.hideZeroBarsWhenGrouped && (k2 -= l2 * v2);
    var A3 = "start", C2 = i2.globals.series[s2][r2] < 0, S2 = a2;
    switch (this.barCtx.isReversed && (S2 = a2 + (C2 ? -h3 : h3), A3 = C2 ? "start" : "end"), p2.position) {
      case "center":
        d2 = C2 ? S2 + h3 / 2 - x2 : Math.max(c2.width / 2, S2 - h3 / 2) + x2;
        break;
      case "bottom":
        d2 = C2 ? S2 + h3 - u2 - x2 : S2 - h3 + u2 + x2;
        break;
      case "top":
    ...
    if (i2.globals.seriesGroups.forEach(function(t4) {
      ...
      C2 ? (y2 = L2 - u2 - x2 - f2.offsetX, A3 = "end") : y2 = L2 + x2 + f2.offsetX + (this.barCtx.isReversed ? -(h3 + u2) : u2), w2 = k2 - c2.height / 2 + M2.height / 2 + f2.offsetY + u2, i2.globals.barGroups.length > 1 && (w2 -= i2.globals.barGroups.length / 2 * (l2 / 2));
    }
    return i2.config.chart.stacked || ("start" === g2.textAnchor ? d2 - c2.width < 0 ? d2 = C2 ? c2.width + u2 : u2 : d2 + c2.width > i2.globals.gridWidth && (d2 = C2 ? i2.globals.gridWidth - u2 : i2.globals.gridWidth - c2.width - u2) : "middle" === g2.textAnchor ? d2 - c2.width / 2 < 0 ? d2 = c2.width / 2 + u2 : d2 + c2.width / 2 > i2.globals.gridWidth && (d2 = i2.globals.gridWidth - c2.width / 2 - u2) : "end" === g2.textAnchor && (d2 < 1 ? d2 = c2.width + u2 : d2 + 1 > i2.globals.gridWidth && (d2 = i2.globals.gridWidth - c2.width - u2))), { bcx: a2, bcy: o2, dataLabelsX: d2, dataLabelsY: k2, totalDataLabelsX: y2, totalDataLabelsY: w2, totalDataLabelsAnchor: A3 };
    ...
    if (h3.enabled && !b2) {
      ...
      if ("vertical" === c2.config.plotOptions.bar.dataLabels.orientation && ("top" === y2 && (h3.textAnchor = v2 ? "end" : "start"), "center" === y2 && (h3.textAnchor = "middle"), "bottom" === y2 && (h3.textAnchor = v2 ? "end" : "start")), this.barCtx.isRangeBar && this.barCtx.barOptions.dataLabels.hideOverflowingLabels)
        l2 < p2.getTextRects(m3, parseFloat(h3.style.fontSize)).width && (m3 = "");
...
var Ma = function() {
  ...
  return s(t2, [{ key: "initVariables", value: function(t3) {
    ...
    for (var l2 = 0; l2 < n2; l2++) {
      ...
      else if (c2.length > 0 && 0 === h3.length)
        if (1 === c2.length)
          o2[c2[0]][l2] = "both";
        else {
...
var Pa = function() {
  ...
  return s(t2, [{ key: "draw", value: function(t3, e2) {
    ...
    var e2 = t3.realIndex, i2 = t3.pathFill, a2 = t3.lineFill, s2 = t3.j, r2 = t3.i, n2 = t3.columnGroupIndex, o2 = t3.pathFrom, l2 = t3.pathTo, h3 = t3.strokeWidth, c2 = t3.elSeries, d2 = t3.x, u2 = t3.y, g2 = t3.y1, p2 = t3.y2, f2 = t3.series, x2 = t3.barHeight, b2 = t3.barWidth, m3 = t3.barXPosition, v2 = t3.barYPosition, y2 = t3.elDataLabelsWrap, w2 = t3.elGoalsMarkers, k2 = t3.elBarShadows, A3 = t3.visibleSeries, C2 = t3.type, S2 = t3.classes, L2 = this.w, M2 = new Mi(this.ctx), P2 = false;
    if (!a2) {
    ...
    var T2 = new La(this).handleBarDataLabels({ x: d2, y: u2, y1: g2, y2: p2, i: r2, j: s2, series: f2, realIndex: e2, columnGroupIndex: n2, barHeight: x2, barWidth: b2, barXPosition: m3, barYPosition: v2, visibleSeries: A3 });
    ...
    if (!P2) {
      var X2 = M2.renderPaths({ i: r2, j: s2, realIndex: e2, pathFrom: o2, pathTo: l2, stroke: a2, strokeWidth: h3, strokeLineCap: L2.config.stroke.lineCap, fill: i2, animationDelay: z2, initialSpeed: L2.config.chart.animations.speed, dataChangeSpeed: L2.config.chart.animations.dynamicAnimation.speed, className: "apexcharts-".concat(C2, "-area ").concat(S2), chartType: C2 });
    ...
    return c2.globals.isXNumeric || (o2 += l2), this.barHelpers.barBackground({ j: u2, i: d2, y1: e2 - a2 * this.visibleI, y2: a2 * this.seriesLen, elSeries: h3 }), { pathTo: x2.pathTo, pathFrom: x2.pathFrom, x1: r2, x: n2, y: o2, goalX: this.barHelpers.getGoalValues("x", r2, null, d2, u2), barYPosition: e2, barHeight: a2 };
...
var Ia = function(t2) {
  ...
  return s(a2, [{ key: "draw", value: function(t3, e3) {
    ...
    for (var e3, i2 = t3.indexes, a3 = t3.barHeight, s2 = t3.strokeWidth, r2 = t3.zeroW, n2 = t3.x, o2 = t3.y, l2 = t3.columnGroupIndex, h3 = t3.seriesGroup, c2 = t3.yDivision, d2 = t3.elSeries, u2 = this.w, g2 = o2 + l2 * a3, p2 = i2.i, f2 = i2.j, x2 = i2.realIndex, b2 = i2.translationsIndex, m3 = 0, v2 = 0; v2 < this.groupCtx.prevXF.length; v2++)
      m3 += this.groupCtx.prevXF[v2][f2];
    var y2 = p2;
    if (u2.config.series[x2].name && (y2 = h3.indexOf(u2.config.series[x2].name)), y2 > 0) {
      var w2 = r2;
    ...
    for (var b2, m3 = i2 + o2 * r2, v2 = 0, y2 = 0; y2 < this.groupCtx.prevYF.length; y2++)
...
var Ta = function(t2) {
  ...
  return s(a2, [{ key: "draw", value: function(t3, e3, i2) {
    ...
    if (o2.globals.previousPaths.length > 0 && (M2 = this.getPreviousPath(g2, c2, true)), this.isOHLC) {
      var P2 = S2 + s2 / 2, I2 = r2 - m3.o / b2, T2 = r2 - m3.c / b2;
    ...
    return M2 += l2.move(S2, k2), o2.globals.isXNumeric || (i2 += a3), { pathTo: L2, pathFrom: M2, x: i2, y: A3, goalY: this.barHelpers.getGoalValues("y", null, r2, h3, c2, e3.translationsIndex), barXPosition: S2, color: w2 };
  ...
  return s(t2, [{ key: "draw", value: function(t3) {
    ...
    for (var h3 = o2 ? 0 : l2.length - 1; o2 ? h3 < l2.length : h3 >= 0; o2 ? h3++ : h3--) {
      ...
      for (var u2 = 0, g2 = e2.config.plotOptions.heatmap.shadeIntensity, p2 = 0, f2 = 0; f2 < e2.globals.dataPoints; f2++)
        if (e2.globals.seriesX.length && !e2.globals.allSeriesHasEqualX && e2.globals.minX + e2.globals.minXDiff * f2 < e2.globals.seriesX[h3][p2])
          u2 += s2;
        else {
          if (p2 >= l2[h3].length)
            break;
...
var Ya = function() {
  ...
  return s(t2, [{ key: "draw", value: function(t3) {
    ...
    for (var e2 = this, i2 = this.w, a2 = t3.parent, s2 = new Ra(this.ctx), r2 = i2.globals.yAxisScale[0].result.reverse(), n2 = r2.length, o2 = [], l2 = this.size / (n2 - 1), h3 = 0; h3 < n2; h3++)
      o2[h3] = l2 * h3;
    o2.reverse();
    var c2 = [], d2 = [];
  ...
  return s(a2, [{ key: "draw", value: function(t3, e3) {
    ...
    for (var s2 = a3.group({ class: "apexcharts-rangebar-series apexcharts-plot-series" }), r2 = 0; r2 < t3.length; r2++) {
      ...
      for (var w2 = a3.group({ class: "apexcharts-datalabels", "data:realIndex": g2 }), k2 = a3.group({ class: "apexcharts-rangebar-goals-markers" }), A3 = 0; A3 < i2.globals.dataPoints; A3++) {
        ...
        if (i2.config.plotOptions.bar.rangeBarGroupRows && (z2 = 1), void 0 === i2.config.series[r2].data[A3])
          break;
        if (this.isHorizontal) {
...
var Fa = function() {
  ...
  return s(t2, [{ key: "sameValueSeriesFix", value: function(t3, e2) {
    ...
    if (void 0 !== (null === (a2 = n2[s2]) || void 0 === a2 ? void 0 : a2[0]))
      o2 = (l2 = d2 && s2 > 0 ? this.lineCtx.prevSeriesY[s2 - 1][0] : this.lineCtx.zeroY) - n2[s2][0] / this.lineCtx.yRatio[h3] + 2 * (this.lineCtx.isReversed ? n2[s2][0] / this.lineCtx.yRatio[h3] : 0);
...
var Da = function(t2) {
  ...
  for (var h3 = 0; h3 <= n2; h3++)
    s2 = (t2[Math.min(n2, h3 + 1)][0] - t2[Math.max(0, h3 - 1)][0]) / (6 * (1 + r2[h3] * r2[h3])), o2.push([s2 || 0, r2[h3] * s2 || 0]);
  return o2;
};
var _a = function(t2) {
...
var Ba = function() {
  ...
  return s(t2, [{ key: "draw", value: function(t3, e2, i2, a2) {
    ...
    for (var c2 = [], d2 = 0; d2 < t3.length; d2++) {
      ...
      if ("rangeArea" === o2) {
        for (var T2 = this._calculatePathsFrom({ series: a2, i: d2, realIndex: g2, prevX: k2, prevY: C2 }), z2 = this._iterateOverDataPoints(u(u({}, P2), {}, { series: a2, xArrj: [m3], yArrj: L2, y2Arrj: M2, pY: w2, areaPaths: I2.areaPaths, pathsFrom: T2, iterations: a2[d2].length - 1, isRangeStart: false })), X2 = I2.linePaths.length / 2, R2 = 0; R2 < X2; R2++)
    ...
    for (var F2, D2 = 0, _2 = 0; _2 < n2 && 0 !== r2[h3].length; _2++) {
      ...
      if (S2.globals.isXNumeric) {
        ...
        c2 += this.xDivision;
      if (H2)
        if (h3 > 0 && S2.globals.collapsedSeries.length < S2.config.series.length - 1) {
      ...
      case "smooth":
        ...
        if (null === i2[a2][r2])
          ...
          switch (p2) {
            ...
            case 1:
              if (null === i2[a2][r2 + 1])
                x2 += S2 ? k2.line(u2, c2) : k2.move(u2, g2), b2 += k2.line(u2, A3) + k2.line(f2, A3) + "z", m3.push(x2), v2.push(b2), p2 = -1;
              else {
  ...
  return function t3(i3, a3, r3, o2, l2) {
    ...
    if (s2(i3[0])) {
      for (c2 = 0; c2 < i3.length; c2++)
        d2[c2] = n2(i3[c2]);
      for (h3 = e2(d2, a3, r3, o2, l2), c2 = 0; c2 < i3.length; c2++)
        u2.push(t3(i3[c2], h3[c2][2] - h3[c2][0], h3[c2][3] - h3[c2][1], h3[c2][0], h3[c2][1]));
    } else
...
var Ua = function() {
  ...
  return s(t2, [{ key: "calculateTimeScaleTicks", value: function(t3, e2) {
    ...
    if (e2.minDate > 1 || e2.minMonth > 0) {
      ...
      1 === e2.minDate && 0 === e2.minMonth && this.timeScaleArray.push({ position: o2, value: n2, unit: h3, year: a2, month: v.monthMod(i2 + 1) });
    for (var d2 = n2, u2 = o2, g2 = 0; g2 < r2; g2++)
      d2++, u2 = l2.determineDaysOfYear(d2 - 1) * s2 + u2, this.timeScaleArray.push({ position: u2, value: d2, unit: h3, year: d2, month: 1 });
    ...
    for (var b2 = u2, m3 = 0; m3 < n2; m3++) {
      if (l2 = "hour", p2 >= 24)
        p2 = 0, l2 = "day", x2 = h3(f2 += 1, x2).month, x2 = c2(f2, x2);
    ...
    for (var e2 = t3.currentMillisecond, i2 = t3.currentSecond, a2 = t3.currentMinute, s2 = t3.currentHour, r2 = t3.currentDate, n2 = t3.currentMonth, o2 = t3.currentYear, l2 = t3.minutesWidthOnXAxis, h3 = t3.secondsWidthOnXAxis, c2 = t3.numberOfMinutes, d2 = a2 + 1, u2 = r2, g2 = n2, p2 = o2, f2 = s2, x2 = (60 - i2 - e2 / 1e3) * h3, b2 = 0; b2 < c2; b2++)
    ...
    for (var e2 = t3.currentMillisecond, i2 = t3.currentSecond, a2 = t3.currentMinute, s2 = t3.currentHour, r2 = t3.currentDate, n2 = t3.currentMonth, o2 = t3.currentYear, l2 = t3.secondsWidthOnXAxis, h3 = t3.numberOfSeconds, c2 = i2 + 1, d2 = a2, u2 = r2, g2 = n2, p2 = o2, f2 = s2, x2 = (1e3 - e2) / 1e3 * l2, b2 = 0; b2 < h3; b2++)
...
var qa = function() {
  ...
  return s(t2, [{ key: "setupElements", value: function() {
    ...
    var i2 = this.w, a2 = this.ctx, s2 = i2.config, r2 = i2.globals, n2 = { line: { series: [], i: [] }, area: { series: [], i: [] }, scatter: { series: [], i: [] }, bubble: { series: [], i: [] }, bar: { series: [], i: [] }, candlestick: { series: [], i: [] }, boxPlot: { series: [], i: [] }, rangeBar: { series: [], i: [] }, rangeArea: { series: [], seriesRangeEnd: [], i: [] } }, o2 = s2.chart.type || "line", l2 = null, h3 = 0;
    ...
    if (r2.comboCharts) {
      ...
      if (n2.area.series.length > 0)
        (x2 = p2).push.apply(x2, f(m3.drawSeriesByGroup(n2.area, r2.areaGroups, "area", c2)));
      ...
      if (n2.rangeArea.series.length > 0 && p2.push(c2.draw(n2.rangeArea.series, "rangeArea", n2.rangeArea.i, n2.rangeArea.seriesRangeEnd)), n2.line.series.length > 0)
        (b2 = p2).push.apply(b2, f(m3.drawSeriesByGroup(n2.line, r2.lineGroups, "line", c2)));
    ...
    switch (t3[0]) {
      ...
      case "A":
        e3 = function(t4, e4) {
          ...
          !X2 && u2 < g2 && (g2 -= 2 * Math.PI);
          for (f2 = Math.ceil(2 * Math.abs(u2 - g2) / Math.PI), b2 = [], m3 = u2, p2 = (g2 - u2) / f2, x2 = 4 * Math.tan(p2 / 4) / 3, k2 = 0; k2 <= f2; k2++)
            y2 = Math.cos(m3), v2 = Math.sin(m3), w2 = new bt(h3.x + y2, h3.y + v2), b2[k2] = [new bt(w2.x + x2 * v2, w2.y - x2 * y2), w2, new bt(w2.x - x2 * v2, w2.y + x2 * y2)], m3 += p2;
          for (b2[0][0] = b2[0][1].clone(), b2[b2.length - 1][2] = b2[b2.length - 1][1].clone(), s3 = new vt().rotate(T2).scale(P2, I2).rotate(-T2), k2 = 0, A3 = b2.length; k2 < A3; k2++)
